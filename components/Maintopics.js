...
export default function Maintopics() {
  return (
    <div className="items-stretch grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 p-10 md:p-10 ">
        ...
        <div className=" rounded border border-lightgray cursor-pointer ">
            ...
            <div>
                ...
                <p className=" text-green text-2xl text-right pr-3 pt-2 pb-2">&rarr;</p>
            </div>
            </Link>
        </div>
        <div className=" rounded border border-lightgray cursor-pointer ">
